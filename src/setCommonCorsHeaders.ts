export default function setCommonCorsHeaders(origin: string | null) {
    ...
    if(origin === "https://nomax-git-testing-onboardingform-rilladubz.vercel.app") {
        headers.set('Access-Control-Allow-Origin', 'https://nomax-git-testing-onboardingform-rilladubz.vercel.app');
    }
